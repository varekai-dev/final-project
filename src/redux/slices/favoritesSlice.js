...
export const removeProductFromFavorite = createAsyncThunk('favorites/removeProductFromFavorite', async (id, { rejectWithValue, dispatch, getState }) => {
	try {
		dispatch(setLoading());
...
export const fetchFavoriteProducts = createAsyncThunk('favorites/fetchFavoriteProducts', async (_, { rejectWithValue, dispatch }) => {
	try {
		dispatch(setLoading());
