...
const RegisterForm = () => {
	...
	return reactDOM.createPortal(
		<Popup>
			<i className={s.closeBtn} onClick={() => dispatch(setActivePopup(''))}>
			...
			<form onSubmit={handleSubmit(onSubmit)}>
				...
				<Input label="Phone number" ref={register} type="tel" name="phone" error={!!errors.phone} helperText={errors?.phone?.message} />
