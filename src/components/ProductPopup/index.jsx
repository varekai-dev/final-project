...
import { addProductToOrder } from '../../redux/slices/ordersSlice';
import { setActivePopup } from '../../redux/slices/popupSlice';
import { fetchSingleProduct, toggleFavorite } from '../../redux/slices/singleProductSlice';
...
const ProductPopup = ({ id }) => {
	...
	const addToCart = () => {
		addProduct();
		dispatch(addNotification(`The  ${product.title} is successfully added to cart `));
		history.push('/');
	};
	const buyOrder = () => {
		addProduct();
						...
						<div className={s.productWrapper}>
							...
							<div className={s.content}>
								...
								<div className={s.description}>
									...
									<Counter decreaseCount={decreaseCount} increaseCount={increaseCount} count={count} />
							...
							<div className={s.buttons}>
								...
								<Button onClick={toogleFavorite} color={product.favorite ? 'orange' : 'transparent'} className={clsx(product.favorite && s.favorite)}>
									{product.favorite ? (
										<span>
