			...
			<div className={s.guestPopup}>
				<div className={s.content}>
					...
					<div className={s.Btns}>
						<Button color="orange" onClick={() => dispatch(setActivePopup('login'))}>
							Continue to sign in
						</Button>
						<Button color="orange" onClick={() => dispatch(setActivePopup('register'))}>
							Continue to register
						</Button>
						<Button color="transparent" onClick={() => dispatch(setActivePopup(null))}>
							Continue as guest
						</Button>
					</div>
				</div>
