      ...
      <div className={s.homeScreen}>
        ...
        {isProductsExistBySearch && (
          <div className={s.noResult}>
            ...
            <p>
              We did not find any article that matches this search Make sure
              that the search text is entered correctly Try using other search
              criteria
            </p>
          </div>
        )}
